...
foreach ($columns as $column) {
    ...
    if ($sort != $column) {
        $columnicon = "";
        $columndir = "DESC";
        $columnicon = "<img class='iconsort' src=\"" . $OUTPUT->image_url('sort_inactive', 'block_fn_mentor') . "\" alt=\"\" />";
    } else {
        if ($dir == 'DESC') {
            $columndir = 'ASC';
            $columnicon = "<img class='iconsort' src=\"" . $OUTPUT->image_url('sort_desc', 'block_fn_mentor') . "\" alt=\"\" />";
        } else if ($dir == 'ASC') {
            $columndir = 'CLEAR';
            $columnicon = "<img class='iconsort' src=\"" . $OUTPUT->image_url('sort_asc', 'block_fn_mentor') . "\" alt=\"\" />";
        } else {
            $columndir = 'DESC';
            $columnicon = "<img class='iconsort' src=\"" . $OUTPUT->image_url('sort_inactive', 'block_fn_mentor') . "\" alt=\"\" />";
        }

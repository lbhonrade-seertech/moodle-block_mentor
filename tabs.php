...
$import = '';
if (is_siteadmin()) {
    $import = html_writer::img($OUTPUT->image_url('i/import'), '', array('class' => 'fn_mentor-tab-icons')) . ' ' .
        html_writer::link(
...
if (has_capability('moodle/site:config', context_system::instance())) {
    $config = html_writer::img($OUTPUT->image_url('i/settings'), '', array('class' => 'fn_mentor-tab-icons')) . ' ' .
        html_writer::link(
...
$info = html_writer::img($OUTPUT->image_url('i/info'), '', array('class' => 'fn_mentor-tab-icons')).' '.
    html_writer::link(

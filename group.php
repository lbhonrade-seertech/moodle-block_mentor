    ...
    foreach ($columns as $column) {
        ...
        switch ($column) {
            ...
            case 'action':
                ...
                $actionicon = html_writer::img($OUTPUT->image_url('cog', 'block_fn_mentor'), $actiontext, array('width' => '16', 'height' => '16'));
                ...
                $actionicon = html_writer::img($OUTPUT->image_url('delete', 'block_fn_mentor'), $actiontext, array('width' => '16', 'height' => '16'));
                $actionlinks .= html_writer::link($actionurl->out(), $actionicon,
                        array('class' => 'actionlink', 'title' => $actiontext)).' ';
